...
class RoomController extends Controller
{
    ...
    public function showRoomStatus()
    {
        ...
        // Count rooms that are currently booked (e.g., status = 'booked')
        $bookedRooms = Booking::where('status', 'booked')->count();

        $availableRooms = $totalRooms - $bookedRooms;

        return view('room_status', compact('availableRooms', 'bookedRooms', 'totalRooms'));
    }
