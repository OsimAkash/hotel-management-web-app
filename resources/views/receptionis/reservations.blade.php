        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>
                        <center>Transaction List</center>
                    </h2>
                </div>
                <div class="card-body">
                    <div class="col-md-12">
                                ...
                                @else
                                    @foreach ($datas as $item)
                                        <tr class="text-center">
                                            ...
                                            <td>@currency($item->payment ? $item->payment->price : 0)</td>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <center>
                                                                        <img width="400px" src="{{ asset('images/proof/' . ($item->payment ? $item->payment->proof : '')) }}" alt="">
                                                                    </center>
                                                                </div>
